...
class WC_Trusted_Shops_Admin {
    ...
    public function output_variation_fields( $loop, $variation_data, $variation ) {
        ...
        <div class="variable_gzd_ts_labels">
            <p class="form-row form-row-first">
                <label for="variable_ts_gtin"><?php echo _x( 'GTIN', 'trusted-shops', 'woocommerce-trusted-shops' );?> <?php echo wc_ts_help_tip( _x( 'ID that allows your products to be identified worldwide. If you want to display your Trusted Shops Product Reviews in Google Shopping and paid Google adverts, Google needs the GTIN.', 'trusted-shops', 'woocommerce-trusted-shops' ) ); ?></label>
            ...
            <p class="form-row form-row-last">
                <label for="variable_ts_mpn"><?php echo _x( 'MPN', 'trusted-shops', 'woocommerce-trusted-shops' );?> <?php echo wc_ts_help_tip( _x( 'If you don\'t have a GTIN for your products, you can pass the brand name and the MPN on to Google to use the Trusted Shops Google Integration.', 'trusted-shops', 'woocommerce-trusted-shops' ) ); ?></label>
    ...
    public function output_fields() {
        ...
        woocommerce_wp_text_input( array( 'id' => '_ts_gtin', 'label' => _x( 'GTIN', 'trusted-shops', 'woocommerce-trusted-shops' ), 'data_type' => 'text', 'desc_tip' => true, 'description' => _x( 'ID that allows your products to be identified worldwide. If you want to display your Trusted Shops Product Reviews in Google Shopping and paid Google adverts, Google needs the GTIN.', 'trusted-shops', 'woocommerce-trusted-shops' ) ) );
        woocommerce_wp_text_input( array( 'id' => '_ts_mpn', 'label' => _x( 'MPN', 'trusted-shops', 'woocommerce-trusted-shops' ), 'data_type' => 'text', 'desc_tip' => true, 'description' => _x( 'If you don\'t have a GTIN for your products, you can pass the brand name and the MPN on to Google to use the Trusted Shops Google Integration.', 'trusted-shops', 'woocommerce-trusted-shops' ) ) );
        ...
        $settings = array(
            ...
            array(
                ...
                'custom_attributes' => array(
                    ...
                    'max'               => 5,
                    'data-validate'     => 'integer',
                    'data-validate-msg' => sprintf( _x( 'Please choose a non-negative number between %d and %d', 'trusted-shops', 'woocommerce-trusted-shops' ),1, 5 ),
                ),
                'css'               => 'max-width:60px;',
            ),
        ...
        if ( $this->base->supports( 'reminder' ) ) {
            ...
            $settings = array_merge( $settings, array(
                ...
                array(
                    ...
                    'type'              => 'html',
                    'html'              => '<a href="' . admin_url( 'admin.php?page=wc-settings&tab=germanized&section=checkboxes&checkbox_id=review_reminder' ) . '" class="button button-secondary" target="_blank">' . _x( 'Edit checkbox', 'trusted-shops', 'woocommerce-trusted-shops' ) . '</a>',
                ),
        ...
        <table class="form-table">
            ...
            <tr valign="top">
                <th scope="row" class="titledesc">
                    <label for="woocommerce_gzd_trusted_shops_review_collector"><?php echo _x( 'Export orders', 'trusted-shops', 'woocommerce-trusted-shops' ); ?> <?php echo wc_ts_help_tip( _x( 'Export your customer and order information of the last x days and upload them in your My Trusted Shops Account.', 'trusted-shops', 'woocommerce-trusted-shops' ) ); ?></label>
                </th>
                <td class="forminp forminp-select forminp-review-collector">
                    <select data-sidebar="wc-ts-sidebar-review-collector" name="woocommerce_<?php echo $this->base->option_prefix; ?>trusted_shops_review_collector" id="woocommerce_<?php echo $this->base->option_prefix; ?>trusted_shops_review_collector" class="chosen_select">
                        <option value="30" <?php selected( 30, $days_interval ); ?>><?php echo _x( '30 days', 'trusted-shops', 'woocommerce-trusted-shops' ); ?></option>
                    ...
                    <div class="trusted-shops-review-collector-wrap">
                        ...
                        <div class="review-collector-buttons">
                            <a class="button button-secondary" id="wc-gzd-trusted-shops-export" data-href-org="<?php echo esc_url( $href_org ); ?>" href="#"><?php echo _x( 'Start export', 'trusted-shops', 'woocommerce-trusted-shops' ); ?></a>
                        </div>
                    </div>
                </td>
            </tr>
