    ...
    public function toggle_input( $value ) {
        ...
        <td class="forminp forminp-<?php echo esc_attr( sanitize_title( $value['type'] ) ); ?>">
            <a href="#" class="woocommerce-ts-input-toggle-trigger">
                <span id="<?php echo esc_attr( $value['id'] ); ?>-toggle" class="woocommerce-ts-input-toggle woocommerce-input-toggle woocommerce-input-toggle--<?php echo ( 'yes' === $option_value ? 'enabled' : 'disabled' ); ?>"><?php echo ( 'yes' === $option_value ? _x( 'Yes', 'trusted-shops', 'woocommerce-trusted-shops' ) : _x( 'No', 'trusted-shops', 'woocommerce-trusted-shops' ) ); ?></span>
            </a>
            <input
