...
echo sprintf( _x( 'Dear %s %s,', 'trusted-shops', 'woocommerce-trusted-shops' ), $order->billing_first_name, $order->billing_last_name ) . "\n\n";
...
echo WC_trusted_shops()->trusted_shops->get_new_review_link( $order->billing_email, $order->id ) . "\n\n";
